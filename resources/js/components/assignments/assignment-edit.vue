                ...
                <div class="mx-auto w-full mb-10">
                    ...
                    <p class="mb-4"> 
                        ...
                        <textarea name="description" placeholder="specify this task..."
                            ...
                            v-model="showedAssignment.description" required
                        >
                        </textarea>
                    </p>
                    <p class="mb-6">
                    ...
                    <div class="mb-4">
                        <input type="radio" v-model="onTime" id="false" name="on_time" :value="false" required>
                        <label for="false">before deadline</label><br>
                        <input type="radio" v-model="onTime" id="true" name="on_time" :value="true" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" v-model="hours" id="duration_hours" name="duration_hours" min="0" class="border w-16 p-2">
                        <label class="mb-2 text-md" for="duration_minutes">Minutes</label>
                        <input type="number" v-model="minutes" id="duration_minutes" name="duration_minutes" min="0" max="59" class="border w-16 p-2">
                        ...
                        <div class="mb-4">
                            ...
                            <div 
                                ...
                                :value="member.id"
                            >
                                <input type="checkbox" v-model="showedAssignment.users" :id="member.id" :name="member.id" :value="member.id">
